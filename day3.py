...
while True:
    ...
    if chose.isdigit():
        ...
        if salary < shop[chose][1]:
            ...
            if chose == 5 and chose > 0 and coupo1 > 0:
                print("是否使用优惠卷")
                ...
                if youhuijuan1 == "y":
                    ...
                    if youhuijuan1 == "n":
                        ...
                        print(shop[chose][0], "添加购物车成功！余额还剩:￥", salary)
                        print("还剩%d张辣条优惠卷" % coupo1)
            elif chose == 9 and chose > 0 and coupo2 > 0:
                print("是否使用优惠卷")
                ...
                if youhuijuan2 == "y":
                    ...
                    mycart.append(shop[chose])
                    print(shop[chose][0], "添加购物车成功！余额还剩:￥", salary)
                    print("还剩%d张机械革命优惠卷" % coupo2)
                else:
                    if youhuijuan2 == "n":
                        salary = salary - shop[chose][1]
                        mycart.append(shop[chose])
                        print(shop[chose][0], "添加购物车成功！余额还剩:￥", salary)
                        print("还剩%d机械革命张优惠卷" % coupo2)
            else:
