...
def transferadd(zhuanru_name, zhuanchu_name, password,account_type):
    ...
    if zhuanru_name in bank and zhuanchu_name in bank:
        if password == bank[zhuanchu_name]["password"]:
            ...
            if account_type == bank[zhuanchu_name]["account_type"] == 1:
                print("您的账户类型为金卡，转出最大额度5万")
            elif zhuanchu_money >= 50000:
                print("您的额度不足")
                return 3
            if account_type == bank[zhuanchu_name]["account_type"] == 2:
                print("您的账户类型为金卡，转出最大额度2万")
            elif zhuanchu_money >= 20000:
                print("您的额度不足")
                return 3
            if account_type == bank[zhuanchu_name]["account_type"] !=1 or account_type == bank[zhuanchu_name]["account_type"] !=2:
                print("没有改账户类型")
                return 1
